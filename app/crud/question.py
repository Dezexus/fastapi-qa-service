...
async def get_question(db: Session, question_id: int):
    ...
    # Сохраняем в кэш (полные сериализованные данные)
    question_response = QuestionResponse.from_orm(question)
    question_data = question_response.dict()
